...
@Service
@AllArgsConstructor
public class GetClientDomainByIdRepositoryService implements IGetClientDomainGetByIdRepository {
    ...
    public ClientDomain execute(Long id) {
        return (ClientDomain) converterDTO.convertObject(this.clientRepository.findById(id), ClientDomain.class);
    }
}
